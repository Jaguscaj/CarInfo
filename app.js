...
function setCardCvc(e){
    cardCvc.innerText = e.taget.value;
}
...
function handleSubmit(e){
    ...
    if(!nameInp.value){
        ...
        nameInp.parentElement.classList.add("error_mesagge");
    } else {
    ...
    if(!numberInp.value){
        ...
        numberInp.parentElement.classList.add("error_mesagge");
    } else {
    ...
    if(!monthInp.value){
        ...
        monthInp.parentElement.classList.add("error_mesagge");
    } else {
    ...
    if(!yearInp.value){
        ...
        yearInp.parentElement.classList.add("error_mesagge");
    } else {
    ...
    if(!cvcInp.value){
        ...
        cvcInp.parentElement.classList.add("error_mesagge");
    } else {
